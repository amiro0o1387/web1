  ...
  <main class="md-main" id="main">
    <section id="home" class="md-page active">
      <div class="md-card hero">
        ...
        <p>اینجا قراره با انواع زبان های برنامه نویسی و با باهم آشنا بشیم</p>
      </div>
    </section>
...
<p style="text-align: center;"><img src="programming-language.webp"></p>
  <div class="container">
    ...
    <nav class="toc">
      <h2>فهرست مطالب</h2>
      <ul>
        <li style="text-align: right"><a href="#id1">مقدمه</a></li>
        <li style="text-align: right"><a href="#id2">تعریف زبان برنامه نویسی ساده</a></li>
        <li style="text-align: right"><a href="#id3">تعریف زبان برنامه نویسی</a></li>
        <li style="text-align: right"><a href="#id4">برنامه نویسی چند زبان دارد؟</a></li>
        <li style="text-align: right"><a href="#id5">برآورد تعداد زبان‌های برنامه نویسی</a></li>
        <li style="text-align: right"><a href="#id6">دلایل عدم وجود عدد دقیق</a></li>
        <li style="text-align: right"><a href="#id7">تفاوت بین زبان‌های پرکاربرد و زبان‌های کمتر شناخته‌شده</a></li>
        <li style="text-align: right"><a href="#id8">برنامه نویسی را از کجا شروع کنیم؟</a></li>
        <li style="text-align: right"><a href="#id9">دسته‌بندی زبان‌های برنامه نویسی</a></li>
      </ul>
    </nav>
...
<p style="text-align: right ;
font-size: 20px;">
<section style="text-align: right" id="id1">
...
<p style="text-align: right;
font-size: 20px;">
    <section style="text-align: right" id="id2">
...
<p style="text-align: right;
font-size: 20px;">
    <section style="text-align: right" id="id3">
...
<section style="text-align: right" id="id4">
    <p style="text-align: right;
 ...
 font-size: 20px;
 font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">
 <section style="text-align: right" id="id5">
 ...
 font-size: 20px;
 font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">
 <section style="text-align: right" id="id6">
 <ol>
    <details>
 <summary style="font-size: 20px; text-align right">جهت خواندن دلایل کلیک کنید</summary>
 <li>
    <b style="font-size: 20px;text-align: right">ظهور زبان‌های جدید:</b> هر ساله زبان‌های جدیدی به وجود می‌آیند که در تلاش برای رفع نیازهای خاص یا ساده‌تر کردن فرآیندهای برنامه نویسی هستند. به همین دلیل، تعداد زبان‌ها به‌طور مداوم در حال تغییر است. 
</li>
    <br>
<li>
    <b style="font-size: 20px; text-align: right">زبان‌های تخصصی و اختصاصی:</b> برخی زبان‌ها برای نیازهای خاص مانند کنترل دستگاه‌ها، شبیه‌سازی‌های علمی، یا مدیریت پایگاه داده طراحی می‌شوند که کمتر شناخته‌شده و استفاده می‌شوند.
</li>
    <br>
 <li>   <b style="font-size: 20px; text-align: right">زبان‌های منسوخ یا کم‌استفاده:</b> بسیاری از زبان‌های قدیمی که دیگر کاربرد چندانی ندارند، همچنان در برخی منابع و کتابخانه‌ها وجود دارند. این زبان‌ها ممکن است شمارش نشوند، اما هنوز هم می‌توان به آن‌ها اشاره کرد.
</li>
</details>
</ol>
</section>
...
font-size: 20px;
font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">
<section style="text-align: right" id="id7">
...
<p id="id9" style="text-align: right;
font-size: 40px;
color: rgb(164, 125, 77);">
<p style="text-align: right;font-size: 25px;color: grey;">دسته‌بندی زبان‌های برنامه نویسی</p>
</p>
<p>
  <section style="text-align: right"><b style="font-size: 25px">۱- زبان‌های سطح بالا (High-Level Languages)</b>
...
<p style="text-align: right">
<br>– ویژگی‌ها:
<li style="text-align: right">نزدیک به زبان طبیعی
</li>
<li style="text-align: right">مدیریت خودکار حافظه (مانند garbage collection)</li>
<li style="text-align: right">مستقل از سخت‌افزار</li>
<li style="text-align: right">قابلیت توسعه سریع</li>
</p>
</section>
</p>
 <div class="container">
